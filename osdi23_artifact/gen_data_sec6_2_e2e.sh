# python equal_model_exp.py --trace-dir /home/zhangy/data/datasets/azurefunctions-dataset2019/azure_v1.pkl --exp-ids all --output azure_v1_1dot3b.tsv --exp-name sec6_2_data --workload=azure_v1 --model-type=bert-1.3b --parallel
